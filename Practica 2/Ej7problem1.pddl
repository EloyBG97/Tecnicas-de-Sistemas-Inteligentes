...
(:objects
    ...
    O1 O2 O3 O4 O5 O6 O7 O8 O9 - Objeto
    Z1 Z2 Z3 Z4 Z5 - Zona
...
(:init
    ...
    (RobotRepartidorRobots R1)
    (RobotRepartidorPersonajes R2)
    ...
    (= (distancia-total R1) 0)
    (= (distancia-total R2) 0)
    ...
    (= (puntuacion-total R1) 0)
    (= (puntuacion-total R2) 0)

    (= (nObjetosBolsillo R1) 0)
    (= (nObjetosBolsillo R2) 0)
    (= (maxObjetosBolsillo) 5)
)

(:goal
    (and
        (> (distancia-total R1) 1)
        (> (distancia-total R2) 1)

        (= (puntuacion-total R2) 50)
    )
)
